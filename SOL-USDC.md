...
Paper mode starts with 1 SOL and 0 USDC. Opening the stopped app or starting a new run resets paper SOL to 1. Existing USDC positions remain. Live balances never reset. Recent transactions clear when the Mini App opens or Start bot succeeds; history stays persisted.
